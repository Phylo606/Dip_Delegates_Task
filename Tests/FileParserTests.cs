...
namespace FileParserTests
{
    public class FileParserTests
    {
        ...
        private string _csvPath = "E:/Swinburne/git repository/Dip_Delegates_Task/data.csv";  // change to appropriate path
        private string _tsvPath = "E:/Swinburne/git repository/Dip_Delegates_Task/data.tsv";  // change to appropriate path

        private string _writeFile = "E:/Swinburne/git repository/Dip_Delegates_Task/dataWrite.txt";  // change to appropriate path
